...
export class Spawn {
    ...
    static define = (): void => {
        ...
        Spawn.base.arcaneCreep.addUnit({ unitType: UnitType.BattleGolem, waves: [1, 2, 3, 4], start: 2 })
        ...
        Spawn.base.arcaneCreep.addUnit({ unitType: UnitType.MagiDefender, waves: [1, 2, 3, 5], start: 6 })
        ...
        Spawn.base.highCity.addUnit({ unitType: UnitType.Militia1, amount: 3, waves: [1, 2, 3, 4, 5, 6], end: 7 })
        Spawn.base.highCity.addUnit({ unitType: UnitType.Arbalist, waves: [1, 2, 3, 4, 5, 6], start: 1 })
        Spawn.base.highCity.addUnit({ unitType: UnitType.Arbalist, waves: [1, 2, 3, 4], start: 5 })
        Spawn.base.highCity.addUnit({ unitType: UnitType.Footman1, waves: [1, 2, 3, 4], start: 4 })
        Spawn.base.highCity.addUnit({ unitType: UnitType.Footman2, amount: 2, waves: [1, 2, 3, 4], start: 8 })
        Spawn.base.highCity.addUnit({ unitType: UnitType.Captain1, amount: 1, waves: [1, 2, 3, 4], start: 9 })
        ...
        Spawn.base.cityFront.addUnit({ unitType: UnitType.Footman1, amount: 3, waves: [1, 2, 3, 4, 5, 6, 7], start: 5 })
        Spawn.base.cityFront.addUnit({ unitType: UnitType.Captain1, amount: 2, waves: [3, 4, 6, 7], start: 5 })
        ...
        Spawn.base.highElvesCreep.addUnit({ unitType: UnitType.HighElfSwordsman, waves: [1, 2, 3, 4], end: 2 })
        Spawn.base.highElvesCreep.addUnit({ unitType: UnitType.HighElfSwordsman, waves: [1, 2, 3, 4], start: 3 })
        ...
        Spawn.base.highElvesCreep.addUnit({ unitType: UnitType.HighElfGuardian, amount: 2, waves: [1, 3, 5], start: 5 })
        ...
        Spawn.base.dwarfCreep.addUnit({ unitType: UnitType.IronGuard, amount: 2, waves: [1, 2, 3, 4] })
        Spawn.base.dwarfCreep.addUnit({ unitType: UnitType.IronGuard, waves: [1, 2, 3, 4], start: 4 })
        Spawn.base.dwarfCreep.addUnit({ unitType: UnitType.IronRifleman, waves: [1, 3], start: 3 })
        Spawn.base.dwarfCreep.addUnit({ unitType: UnitType.IronCaptain, waves: [1, 3, 4], start: 4 })
        Spawn.base.dwarfCreep.addUnit({ unitType: UnitType.IronMagi, waves: [2], start: 5 })
        ...
        Spawn.base.nagaCreep.addUnit({ unitType: UnitType.NagaMyrmidon, waves: [1, 2, 3, 4], start: 2 })
        Spawn.base.nagaCreep.addUnit({ unitType: UnitType.NagaMyrmidon, waves: [1, 2], start: 4 })
        Spawn.base.nagaCreep.addUnit({ unitType: UnitType.NagaSiren, waves: [2, 4], start: 3 })
        Spawn.base.nagaCreep.addUnit({ unitType: UnitType.SnapDragon, waves: [2, 3, 4, 5, 6], start: 5 })
