...
export class Rectangles {
	...
	Left_Orc: Rectangle
	Right_Orc: Rectangle
	Furbolg_Left: Rectangle
	Furbolg_Right: Rectangle
	...
	constructor () {
		...
		this.Furbolg_Left = Rectangle.fromHandle(gg_rct_Furbolg_Left)
		this.Furbolg_Right = Rectangle.fromHandle(gg_rct_Furbolg_Right)
