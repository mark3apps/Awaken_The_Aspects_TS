import { ILocsDepend } from './ILocsDepend'
import { Loc } from './loc'
import { ILocPair } from "./ILocPair"
...
export class Locs {
	...
	constructor (depend: ILocsDepend) {
		...
		this.sKolbold = {
			alliance: new Loc(depend, { rect: rects.Furbolg_Left }),
			federation: new Loc(depend, { rect: rects.Furbolg_Right })
		}
		this.sMurloc = {
