...
export class Spawns {
	...
	constructor (depend: ISpawnsDepend) {
		...
		this.base.cityElves.addUnit({ unitType: unitTypes.BloodElfArcher, waves: [1, 2, 3, 4, 5, 6], start: 2 })
		this.base.cityElves.addUnit({ unitType: unitTypes.BloodElfArcher, waves: [2, 3, 4, 5], start: 4 })
		...
		this.base.cityElves.addUnit({ unitType: unitTypes.BloodElfMage, waves: [1, 2, 3, 4, 5, 7], start: 7 })
		...
		this.base.murloc.addUnit({ unitType: unitTypes.MurlocCliffRunner, amount: 3, waves: [5, 6, 7, 8, 9, 10] })
		this.base.murloc.addUnit({ unitType: unitTypes.MurlocCliffRunner, amount: 2, waves: [5, 6, 7, 8], start: 5 })
		this.base.murloc.addUnit({ unitType: unitTypes.MurlocReaver, waves: [5, 7, 9], start: 3 })
		this.base.murloc.addUnit({ unitType: unitTypes.MurlocSnareCaster, waves: [6, 7, 8, 10], start: 4 })
