...
export class Abilities {
	...
	private constructor (depend: IAbilitiesDepend) {
		...
		new Ability(depend, {
			...
			unitAbility: (unitAbil) => { return FootmanUpgrade.fromHandle(unitAbil) }
		})
		// Fel Grunt
		new Ability(depend, {
			abilType: abilTypes.FelGrunt,
			TriggerUnit: abilCast.KillingUnit,
			unitAbility: (unitAbil) => { return FelGrunt.fromHandle(unitAbil) }
		})
		// Fel Ogre
		new Ability(depend, {
			abilType: abilTypes.FelOgre,
			TriggerUnit: abilCast.KillingUnit,
			unitAbility: (unitAbil) => { return FelOgre.fromHandle(unitAbil) }
		})
		// Fel Warlord
		new Ability(depend, {
			abilType: abilTypes.FelWarlord,
			TriggerUnit: abilCast.KillingUnit,
			unitAbility: (unitAbil) => { return FelWarlord.fromHandle(unitAbil) }
		})
		// Fel Warlock
		new Ability(depend, {
			abilType: abilTypes.FelWarlock,
			TriggerUnit: abilCast.KillingUnit,
			unitAbility: (unitAbil) => { return FelWarlock.fromHandle(unitAbil) }
		})
		// Mana Tower Restore
		new Ability(depend, {
			abilType: abilTypes.ManaTowerRestore,
			TriggerUnit: abilCast.AttackingUnit,
			unitAbility: (unitAbil) => { return ManaTowerRestore.fromHandle(unitAbil) }
		})
		...
		new Ability(depend, {
			...
			TriggerUnit: abilCast.AttackingUnit,
			unitAbility: (unitAbil) => { return ManaShieldTower.fromHandle(unitAbil) }
		})
		// Mana Shards Tower
		new Ability(depend, {
			abilType: abilTypes.ManaShardsTower,
			TriggerUnit: abilCast.AttackingUnit,
			unitAbility: (unitAbil) => { return ManaShardsTower.fromHandle(unitAbil) }
		})
		// Chain Lightning Tower
		new Ability(depend, {
			abilType: abilTypes.ChainLightningTower,
			TriggerUnit: abilCast.AttackingUnit,
			unitAbility: (unitAbil) => { return ChainLightningTower.fromHandle(unitAbil) }
		})
		// Cone of Fire
		new Ability(depend, {
			abilType: abilTypes.ConeOfFireTower,
			TriggerUnit: abilCast.AttackingUnit,
			unitAbility: (unitAbil) => { return ConeOfFireTower.fromHandle(unitAbil) }
		})
		// Aspect of Death Infect
		new Ability(depend, {
			abilType: abilTypes.AspectOfDeathInfect,
			TriggerUnit: abilCast.AttackingUnit,
			unitAbility: (unitAbil) => { return AspectOfDeathInfect.fromHandle(unitAbil) }
		})
		...
		this.bonusCollection = new Ability(depend, {
			...
			TriggerUnit: abilCast.CastingUnit,
			unitAbility: (unitAbil) => { return UnitAbility.fromHandle(unitAbil) }
		})
		this.bonusDamage = new Ability(depend, {
			abilType: abilTypes.bonusDamage,
			TriggerUnit: abilCast.CastingUnit,
			unitAbility: (unitAbil) => { return BonusDamage.fromHandle(unitAbil) }
		})
		this.bonusArmor = new Ability(depend, {
			abilType: abilTypes.bonusArmor,
			TriggerUnit: abilCast.CastingUnit,
			unitAbility: (unitAbil) => { return BonusArmor.fromHandle(unitAbil) }
		})
		this.bonusStats = new Ability(depend, {
			abilType: abilTypes.bonusStats,
			TriggerUnit: abilCast.CastingUnit,
			unitAbility: (unitAbil) => { return BonusStats.fromHandle(unitAbil) }
		})
		this.bonusAttackSpeed = new Ability(depend, {
			abilType: abilTypes.bonusAttackSpeed,
			TriggerUnit: abilCast.CastingUnit,
			unitAbility: (unitAbil) => { return BonusAttackSpeed.fromHandle(unitAbil) }
		})
		this.bonusMoveSpeed = new Ability(depend, {
			abilType: abilTypes.bonusMoveSpeed,
			TriggerUnit: abilCast.CastingUnit,
			unitAbility: (unitAbil) => { return BonusMoveSpeed.fromHandle(unitAbil) }
		})
		this.bonusLifeRegen = new Ability(depend, {
			abilType: abilTypes.bonusLifeRegen,
			TriggerUnit: abilCast.CastingUnit,
			unitAbility: (unitAbil) => { return BonusLifeRegen.fromHandle(unitAbil) }
		})
		...
		this.treeSkill = new Ability(depend, {
			...
			TriggerUnit: abilCast.CastingUnit,
			unitAbility: (unitAbil) => { return SkillTree.fromHandle(unitAbil) }
		})
	}
}
