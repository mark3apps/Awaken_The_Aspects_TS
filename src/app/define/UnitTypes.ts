...
import { UnitFour } from 'lib/w3ts/index'
import { UnitType } from '../classes/unitType/UnitType'
...
export class UnitTypes {
  ...
  constructor() {
    ...
    this.AspectOfTheStorm = new UnitType({ four: UnitFour.BerserkElemental, preload: false })
