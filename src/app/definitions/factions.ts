...
import { ARMY, LOC } from "./index"
    ...
    export function define(): void {
        ...
        draenei = {
            alliance: new Base(Unit.fromHandle(gg_unit_ndh2_0359), ARMY.Alliance, LOC.sDraenei.alliance, LOC.top.federation, 2, true, true, true),
            federation: new Base(Unit.fromHandle(gg_unit_ndh2_0876), ARMY.Federation, LOC.sDraenei.federation, LOC.bottom.alliance, 2, true, true, true)
        }
        undead = {
