...
export class UnitType {
	...
	// Buildings
	static CastleGateOpen = new UnitType({ four: 'h020', order: false })
	static CastleGateClosed = new UnitType({ four: 'h021', order: false })
	...
	static DwarvenGateClosed = new UnitType({ four: 'h01G', order: false })
	static DwarvenGateOpen = new UnitType({ four: 'h01C', order: false })
	static MercTent = new UnitType({ four: 'n00m', order: false })
	static MercLookout = new UnitType({ four: 'o004', order: false })
	static Nerubianziggurat = new UnitType({ four: UnitFour.Nerubianziggurat, order: false })
	static WildhammerCottage = new UnitType({ four: 'h01W', order: false })
	static WildhammerFarmLarge = new UnitType({ four: 'h01F', order: false })
	static WildhammerFarm = new UnitType({ four: 'h01U', order: false })
	static WildhammerMound = new UnitType({ four: 'h01X', order: false })
	static ArcaneManaTower = new UnitType({ four: 'h00G', order: false })
	static ArcaneFlameTower = new UnitType({ four: 'nft2', order: false })
	static ArcaneSorcerersTower = new UnitType({ four: 'n007', order: false })
	static ArcaneManaRepository = new UnitType({ four: 'h024', order: false })
