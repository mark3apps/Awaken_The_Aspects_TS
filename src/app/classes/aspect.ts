...
export class Aspect {
    ...
    static define = (): void => {
        ...
        // Aspect of the Earth
        new Aspect(80, gg_unit_n01A_0569, gg_unit_h006_0074, Force.Alliance, Loc.sCityFront.federation, gg_rct_Rock_Gate_Left, ID.Destructible.IcyGate)
        new Aspect(80, gg_unit_n01A_0399, gg_unit_h006_0055, Force.Federation, Loc.sCityFront.alliance, gg_rct_Rock_Gate_Right, ID.Destructible.IcyGate)
