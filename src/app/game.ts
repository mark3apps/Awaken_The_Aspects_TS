...
import { BaseEngine } from './classes/baseEngine/BaseEngine'
...
export class Game {
  ...
  static start = (): void => {
    ...
    const baseEngine = BaseEngine.initInstance({ baseGroups: baseGroups }, { waveInterval: 7, baseGroupInterval: 0.05, cycleInterval: 10, unitInterval: 0.02 })
