...
export class Game {
  ...
  static start = (): void => {
    ...
    // const baseEngine = BaseSpawnEngine.initInstance(
    //   { baseGroups: baseGroups },
    //   { waveInterval: 10, baseGroupInterval: 0.5, cycleInterval: 1, unitInterval: 0.07 }
    // )
    // const abilEngine = AbilityEngine.getInstance({ triggers: triggers, abilityCast: abilCast })
    // const pathing = Pathing.getInstance({
    //   triggers: triggers,
    //   locs: locs,
    //   forces: forces,
    //   regions: regions,
    ...
    // const heroAbils = HeroAbilities.getInstance({
    //   abilityTypes: abilTypes,
    //   abilityCast: abilCast,
    //   abilityEngine: abilEngine,
    // })
