...
function CreateUnitsForPlayer0()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("nw2w"), -6867.1, 6507.4, 289.751, FourCC("nw2w"))
    u = BlzCreateUnitWithSkin(p, FourCC("nchw"), -6766.6, 6503.1, 214.295, FourCC("nchw"))
    u = BlzCreateUnitWithSkin(p, FourCC("h00K"), -7655.7, 6688.1, 141.970, FourCC("h00K"))
    u = BlzCreateUnitWithSkin(p, FourCC("n018"), -7535.8, 6516.5, 258.628, FourCC("n018"))
end
...
function CreateBuildingsForPlayer20()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n00M"), -14400.0, -8256.0, 270.000, FourCC("n00M"))
    SetUnitState(u, UNIT_STATE_MANA, 260)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n011"), -21600.0, -608.0, 270.000, FourCC("n011"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n012"), -21728.0, -1376.0, 270.000, FourCC("n012"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n013"), -21472.0, -2656.0, 270.000, FourCC("n013"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ntt1"), -17344.0, 1984.0, 270.000, FourCC("ntt1"))
...
function CreateUnitsForPlayer20()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("h012"), -20236.3, -8518.4, -11.390, FourCC("h012"))
    u = BlzCreateUnitWithSkin(p, FourCC("h012"), -20156.3, -6553.9, -116.390, FourCC("h012"))
...
function CreateBuildingsForPlayer23()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("h01C"), -12864.0, 1088.0, 270.001, FourCC("h01C"))
    u = BlzCreateUnitWithSkin(p, FourCC("ncba"), -10464.0, -5280.0, 90.000, FourCC("ncba"))
    gg_unit_h014_0158 = BlzCreateUnitWithSkin(p, FourCC("h014"), -6272.0, 1920.0, 270.000, FourCC("h014"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nfv4"), -7328.0, -4000.0, 270.000, FourCC("nfv4"))
    ...
    gg_unit_hshy_0212 = BlzCreateUnitWithSkin(p, FourCC("hshy"), -8544.0, -2656.0, 270.000, FourCC("hshy"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nfv4"), -7456.0, -5728.0, 270.000, FourCC("nfv4"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n004"), -10080.0, 1856.0, 270.000, FourCC("n004"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("h01C"), -11648.0, 2432.0, 360.000, FourCC("h01C"))
    u = BlzCreateUnitWithSkin(p, FourCC("h01C"), -14208.0, 4032.0, 179.440, FourCC("h01C"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("h01C"), -11200.0, 4160.0, 360.000, FourCC("h01C"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n004"), -7264.0, 2560.0, 270.000, FourCC("n004"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n004"), -7264.0, 1152.0, 270.000, FourCC("n004"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n004"), -9312.0, 4224.0, 270.000, FourCC("n004"))
...
function CreateNeutralPassive()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("h00C"), -7613.2, 6636.0, 257.160, FourCC("h00C"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n00W"), -7177.5, 6513.0, 262.903, FourCC("n00W"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nogo"), -7261.2, 6512.5, 266.334, FourCC("nogo"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nchp"), -7578.8, 6520.4, 277.372, FourCC("nchp"))
    u = BlzCreateUnitWithSkin(p, FourCC("hgry"), -8222.8, 6390.1, 256.791, FourCC("hgry"))
    u = BlzCreateUnitWithSkin(p, FourCC("nws1"), -8333.7, 6374.7, 30.257, FourCC("nws1"))
    u = BlzCreateUnitWithSkin(p, FourCC("hgyr"), -8636.3, 6525.0, 269.964, FourCC("hgyr"))
    u = BlzCreateUnitWithSkin(p, FourCC("ehpr"), -8652.7, 6426.8, 222.156, FourCC("ehpr"))
    u = BlzCreateUnitWithSkin(p, FourCC("hgyr"), -7088.3, 6262.7, 331.402, FourCC("hgyr"))
    u = BlzCreateUnitWithSkin(p, FourCC("uskm"), -6802.8, 6410.8, 117.414, FourCC("uskm"))
    u = BlzCreateUnitWithSkin(p, FourCC("nske"), -6883.3, 6416.4, 96.023, FourCC("nske"))
    u = BlzCreateUnitWithSkin(p, FourCC("nsca"), -6944.2, 6419.2, 146.265, FourCC("nsca"))
end
...
function CreateRegions()
    ...
    gg_rct_Big_Top_Right = Rect(-11872.0, -1088.0, 1824.0, 7296.0)
...
function InitAllyPriorities()
    ...
    SetStartLocPrio(10, 1, 7, MAP_LOC_PRIO_HIGH)
...
function config()
    ...
    DefineStartLocation(2, -14592.0, -10048.0)
    ...
    DefineStartLocation(7, -1856.0, -9152.0)
