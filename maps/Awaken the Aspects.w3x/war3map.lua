...
function CreateBuildingsForPlayer20()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("hgtw"), -19456.0, -7296.0, 270.000, FourCC("hgtw"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n00M"), -14144.0, -8192.0, 270.000, FourCC("n00M"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("h004"), -18368.0, -7616.0, 270.000, FourCC("h004"))
    ...
    gg_unit_n00B_0102 = BlzCreateUnitWithSkin(p, FourCC("n00B"), -19840.0, -7424.0, 270.000, FourCC("n00B"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n00M"), -14528.0, -8448.0, 270.000, FourCC("n00M"))
...
function CreateUnitsForPlayer20()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("h012"), -20824.8, -8761.7, 344.772, FourCC("h012"))
...
function CreateBuildingsForPlayer23()
    ...
    gg_unit_n00B_0038 = BlzCreateUnitWithSkin(p, FourCC("n00B"), -9216.0, -1664.0, 270.000, FourCC("n00B"))
    ...
    gg_unit_o001_0078 = BlzCreateUnitWithSkin(p, FourCC("o001"), -10176.0, -8320.0, 270.000, FourCC("o001"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("o005"), -10752.0, -8448.0, 270.000, FourCC("o005"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ndh1"), -12864.0, -9536.0, 270.000, FourCC("ndh1"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("o005"), -10112.0, -7744.0, 270.000, FourCC("o005"))
    u = BlzCreateUnitWithSkin(p, FourCC("o000"), -11904.0, -7808.0, 270.000, FourCC("o000"))
    u = BlzCreateUnitWithSkin(p, FourCC("o003"), -10784.0, -7840.0, 270.000, FourCC("o003"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ntt1"), -12928.0, -9280.0, 270.000, FourCC("ntt1"))
...
function CreateRegions()
    ...
    gg_rct_Human_Shipyard_Left = Rect(-20832.0, -7040.0, -20448.0, -6656.0)
    gg_rct_Human_Shipyard_Right = Rect(-8704.0, -2496.0, -8128.0, -2112.0)
...
function CreateCameras()
    ...
    CameraSetupSetField(gg_cam_intro09, CAMERA_FIELD_FARZ, 5747.0, 0.0)
