...
function CreateBuildingsForPlayer20()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("h01C"), -17405.9, -11799.6, 180.000, FourCC("h01C"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("h020"), -24281.5, -5762.6, 270.000, FourCC("h020"))
...
function CreateBuildingsForPlayer23()
    ...
    life = GetUnitState(u, UNIT_STATE_LIFE)
    SetUnitState(u, UNIT_STATE_LIFE, 0.40 * life)
    gg_unit_n00B_0399 = BlzCreateUnitWithSkin(p, FourCC("n00B"), -12288.0, -2240.0, 270.000, FourCC("n00B"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ncbb"), -12256.0, -1504.0, 90.000, FourCC("ncbb"))
    u = BlzCreateUnitWithSkin(p, FourCC("n00M"), -14592.0, -1984.0, 270.000, FourCC("n00M"))
    u = BlzCreateUnitWithSkin(p, FourCC("hhou"), -14848.0, -3200.0, 270.000, FourCC("hhou"))
    ...
    SetUnitState(u, UNIT_STATE_MANA, 260)
    u = BlzCreateUnitWithSkin(p, FourCC("hhou"), -14208.0, -3456.0, 270.000, FourCC("hhou"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ncbb"), -12000.0, -3232.0, 90.000, FourCC("ncbb"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("h01C"), -11202.1, 4183.6, 0.000, FourCC("h01C"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("h01C"), -11650.1, 2455.6, 0.000, FourCC("h01C"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("h01F"), -16000.0, 3840.0, 48.570, FourCC("h01F"))
...
function CreateUnitsForPlayer23()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("h01S"), -10112.0, -4224.0, 90.000, FourCC("h01S"))
...
function CreateNeutralHostile()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("uabo"), -27301.5, -5000.3, 120.430, FourCC("uabo"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nmsc"), -21843.5, 4584.0, 127.640, FourCC("nmsc"))
    SetUnitState(u, UNIT_STATE_MANA, 600)
    u = BlzCreateUnitWithSkin(p, FourCC("nelb"), -27616.2, -9737.5, 212.870, FourCC("nelb"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nggg"), -13558.5, 6321.9, 280.390, FourCC("nggg"))
    u = BlzCreateUnitWithSkin(p, FourCC("nggg"), -15489.4, -15737.0, 100.390, FourCC("nggg"))
end
