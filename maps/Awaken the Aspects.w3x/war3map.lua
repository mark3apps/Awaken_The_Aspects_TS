...
function CreateUnitsForPlayer0()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("h011"), -15667.6, -4804.7, 108.900, FourCC("h011"))
    u = BlzCreateUnitWithSkin(p, FourCC("h011"), -15650.3, -5140.1, 141.475, FourCC("h011"))
    u = BlzCreateUnitWithSkin(p, FourCC("h011"), -15568.2, -5242.2, 238.927, FourCC("h011"))
    u = BlzCreateUnitWithSkin(p, FourCC("h011"), -15476.6, -4959.6, 198.002, FourCC("h011"))
    u = BlzCreateUnitWithSkin(p, FourCC("h011"), -15865.9, -4967.0, 158.538, FourCC("h011"))
    u = BlzCreateUnitWithSkin(p, FourCC("h011"), -15805.1, -5001.5, 177.786, FourCC("h011"))
    u = BlzCreateUnitWithSkin(p, FourCC("h011"), -15848.3, -4747.9, 168.426, FourCC("h011"))
