...
function CreateBuildingsForPlayer20()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("hgtw"), -18688.0, -6208.0, 270.000, FourCC("hgtw"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("h00G"), -20864.0, -11328.0, 270.000, FourCC("h00G"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nft2"), -20416.0, -11136.0, 270.000, FourCC("nft2"))
    u = BlzCreateUnitWithSkin(p, FourCC("nft2"), -20416.0, -11520.0, 270.000, FourCC("nft2"))
...
function CreateUnitsForPlayer20()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n004"), -22279.5, -12071.3, 0.000, FourCC("n004"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n004"), -22279.5, -10584.7, 180.000, FourCC("n004"))
...
function CreateRegions()
    ...
    gg_rct_Camp_Bottom = Rect(-13984.0, -12864.0, -12736.0, -12032.0)
    ...
    gg_rct_Human_Shipyard_Left = Rect(-20800.0, -6944.0, -20416.0, -6560.0)
