...
function CreateUnitsForPlayer20()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("e008"), -26591.2, 5994.5, 357.704, FourCC("e008"))
end
...
function CreateBuildingsForPlayer23()
    ...
    SetUnitState(u, UNIT_STATE_MANA, 260)
    u = BlzCreateUnitWithSkin(p, FourCC("hhou"), -14016.0, -2176.0, 270.000, FourCC("hhou"))
...
function CreateNeutralHostile()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("e008"), -26407.3, 5715.3, 357.704, FourCC("e008"))
