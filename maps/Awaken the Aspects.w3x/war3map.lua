...
function CreateBuildingsForPlayer20()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("hgtw"), -18368.0, -7616.0, 270.000, FourCC("hgtw"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("h004"), -19904.0, -8000.0, 270.000, FourCC("h004"))
    u = BlzCreateUnitWithSkin(p, FourCC("hgtw"), -21312.0, -7040.0, 270.000, FourCC("hgtw"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n01L"), -24064.0, -12672.0, 270.000, FourCC("n01L"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("h013"), -23104.4, -6721.9, 270.000, FourCC("h013"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("h019"), -19904.0, -7584.0, 270.000, FourCC("h019"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n01L"), -24064.0, -9984.0, 270.000, FourCC("n01L"))
...
function CreateUnitsForPlayer20()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n00U"), -21422.2, -11004.9, 90.000, FourCC("n00U"))
    u = BlzCreateUnitWithSkin(p, FourCC("n01K"), -22688.0, -12160.0, 180.000, FourCC("n01K"))
    u = BlzCreateUnitWithSkin(p, FourCC("n00U"), -21422.2, -11676.9, 90.000, FourCC("n00U"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n01G"), -23648.0, -12896.0, 270.000, FourCC("n01G"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n01D"), -22336.0, -12064.0, 90.000, FourCC("n01D"))
    u = BlzCreateUnitWithSkin(p, FourCC("n00S"), -24736.0, -13088.0, 270.000, FourCC("n00S"))
    u = BlzCreateUnitWithSkin(p, FourCC("h012"), -19100.9, -6596.5, 235.334, FourCC("h012"))
    u = BlzCreateUnitWithSkin(p, FourCC("h012"), -19205.6, -7809.4, 28.610, FourCC("h012"))
    u = BlzCreateUnitWithSkin(p, FourCC("n01B"), -24160.0, -9472.0, 0.000, FourCC("n01B"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n01H"), -22816.0, -12416.0, -90.000, FourCC("n01H"))
    u = BlzCreateUnitWithSkin(p, FourCC("h01D"), -15010.3, -6534.5, 35.258, FourCC("h01D"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n01B"), -24160.0, -13184.0, 0.000, FourCC("n01B"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n01G"), -22816.0, -13056.0, 180.000, FourCC("n01G"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n01G"), -22816.0, -9600.0, 180.000, FourCC("n01G"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n01D"), -22336.0, -10592.0, 270.000, FourCC("n01D"))
...
function CreateBuildingsForPlayer23()
    ...
    gg_unit_h014_0158 = BlzCreateUnitWithSkin(p, FourCC("h014"), -6272.0, 2048.0, 270.000, FourCC("h014"))
    ...
    SetUnitColor(u, ConvertPlayerColor(0))
    u = BlzCreateUnitWithSkin(p, FourCC("hgtw"), -11392.0, -5120.0, 270.000, FourCC("hgtw"))
    u = BlzCreateUnitWithSkin(p, FourCC("ndh1"), -12992.0, -9536.0, 270.000, FourCC("ndh1"))
    u = BlzCreateUnitWithSkin(p, FourCC("hgtw"), -7744.0, -2304.0, 270.000, FourCC("hgtw"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("hgtw"), -7744.0, -1088.0, 270.000, FourCC("hgtw"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("hgtw"), -7744.0, -1664.0, 270.000, FourCC("hgtw"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("h004"), -9152.0, -1344.0, 270.000, FourCC("h004"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("hgtw"), -10688.0, -3136.0, 270.000, FourCC("hgtw"))
    ...
    life = GetUnitState(u, UNIT_STATE_LIFE)
    SetUnitState(u, UNIT_STATE_LIFE, 0.30 * life)
    u = BlzCreateUnitWithSkin(p, FourCC("hgtw"), -10688.0, -1728.0, 270.000, FourCC("hgtw"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("h01M"), -13536.0, 1632.0, 90.000, FourCC("h01M"))
...
function CreateUnitsForPlayer23()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n00U"), -7377.8, 956.9, 180.000, FourCC("n00U"))
    u = BlzCreateUnitWithSkin(p, FourCC("n00U"), -7633.8, 2332.9, 180.000, FourCC("n00U"))
    u = BlzCreateUnitWithSkin(p, FourCC("n00U"), -7633.8, 1660.9, 180.000, FourCC("n00U"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ncba"), -10656.0, -4832.0, 90.000, FourCC("ncba"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ncba"), -10080.0, -3488.0, 90.000, FourCC("ncba"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ncba"), -9888.0, -3488.0, 90.000, FourCC("ncba"))
    u = BlzCreateUnitWithSkin(p, FourCC("ncba"), -9888.0, -4768.0, 90.000, FourCC("ncba"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ncba"), -9696.0, -4768.0, 90.000, FourCC("ncba"))
    u = BlzCreateUnitWithSkin(p, FourCC("ncba"), -10464.0, -4832.0, 90.000, FourCC("ncba"))
    u = BlzCreateUnitWithSkin(p, FourCC("ncba"), -10272.0, -4832.0, 90.000, FourCC("ncba"))
...
function CreateNeutralHostile()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("nvdl"), -2083.1, 2939.3, 211.922, FourCC("nvdl"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nvdw"), -2878.1, 3958.2, 295.135, FourCC("nvdw"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nvdl"), -2676.7, 3854.5, 92.299, FourCC("nvdl"))
    u = BlzCreateUnitWithSkin(p, FourCC("nvde"), -1286.5, 1371.8, 24.940, FourCC("nvde"))
    u = BlzCreateUnitWithSkin(p, FourCC("nvdl"), -2773.9, 3643.1, 18.095, FourCC("nvdl"))
...
function CreateRegions()
    ...
    gg_rct_Left_Start_Bottom = Rect(-19040.0, -13728.0, -18784.0, -6816.0)
    gg_rct_Left_Start_Top = Rect(-20800.0, -2880.0, -20320.0, 4672.0)
    gg_rct_Right_Start_Top = Rect(-10304.0, -2336.0, -10016.0, 4544.0)
...
function CreateCameras()
    ...
    CameraSetupSetField(gg_cam_intro04, CAMERA_FIELD_ROTATION, 132.9, 0.0)
    CameraSetupSetField(gg_cam_intro04, CAMERA_FIELD_ANGLE_OF_ATTACK, 357.2, 0.0)
    ...
    CameraSetupSetDestPosition(gg_cam_intro04, -19173.3, -4527.6, 0.0)
    ...
    CameraSetupSetField(gg_cam_intro09, CAMERA_FIELD_FARZ, 6489.0, 0.0)
    ...
    CameraSetupSetDestPosition(gg_cam_intro09, -20878.0, -11323.6, 0.0)
    ...
    CameraSetupSetField(gg_cam_intro11, CAMERA_FIELD_NEARZ, 444.0, 0.0)
    ...
    CameraSetupSetField(gg_cam_intro12, CAMERA_FIELD_ROTATION, 32.0, 0.0)
    ...
    CameraSetupSetField(gg_cam_intro12, CAMERA_FIELD_FARZ, 3645.0, 0.0)
    ...
    CameraSetupSetDestPosition(gg_cam_intro12, -21679.1, -7888.0, 0.0)
